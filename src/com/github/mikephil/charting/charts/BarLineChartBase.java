...
//        int temp=mXAxis.mAxisLabelModulus;
//        int temp2=mXAxis.mLabelWidth;
//        float temp3= mViewPortHandler.contentWidth();
        if (mLogEnabled)
...
//    	 Matrix save = mViewPortHandler.zoomIn(getWidth() / 2f, -getHeight() );
...
//    	 Matrix save = mViewPortHandler.zoomOut(getWidth() / 2f, getHeight() );
        mViewPortHandler.refresh(save, this, true);
    }
