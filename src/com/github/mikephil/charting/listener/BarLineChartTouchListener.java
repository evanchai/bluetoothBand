...
//		mMatrix.postTranslate(dX, dY);                      //只在x上移动
     ...
     * @throws Exception 
     */
    private void performHighlight(MotionEvent e) throws Exception {

        Highlight h = mChart.getHighlightByTouchPoint(e.getX(), e.getY());

//        if (h == null || h.equalTo(mLastHighlighted)) {              //2015 如果原来没有或和上次的相同，那么不显示
...
//        }
     ...
     * @throws Exception 
     */
    private void performHighlightDrag(MotionEvent e) throws Exception {
...
//        -------------2015-----------------
        ...
        DemoBase mChartActivityMonth= mChart.getChartactivity();
        if(mChartActivityMonth instanceof MultiLineChartActivityMonth&&taptime<=2)                  //如果是MultiLineChartActivity不做双击
        	result=((MultiLineChartActivityMonth)mChartActivityMonth).initDataSet(taptime);
